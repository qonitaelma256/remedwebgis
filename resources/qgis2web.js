...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32749',
            //extent: [641993.643582, 9063985.758466, 715795.992562, 9141877.759280],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([612232.002927, 9050117.009945, 763565.672140, 9168201.278491], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title"> Kesesuaian Lahan Permukiman di Kabupaten Malang</h2>';
        return titleElement;
    })(),
